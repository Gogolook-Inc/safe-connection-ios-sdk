Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://github.com/Gogolook-Inc/safe-connection-ios-sdk/releases/download/0.5.9/SafeConnection.xcframework.zip' }
  ...
  s.prepare_command = <<-CMD
    curl -L -o SafeConnection.xcframework.zip 'https://github.com/Gogolook-Inc/safe-connection-ios-sdk/releases/download/0.5.9/SafeConnection.xcframework.zip'
