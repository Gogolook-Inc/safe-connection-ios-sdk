Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://github.com/Gogolook-Inc/safe-connection-ios-sdk/releases/download/0.5.13/SafeConnection.xcframework.zip' }
  ...
  # s.dependency 'RealmSwift', '10.54.5' # Removed for testing
  s.dependency 'SSZipArchive', '>= 2.6.0'

  s.prepare_command = <<-CMD
    curl -L -o SafeConnection.xcframework.zip 'https://github.com/Gogolook-Inc/safe-connection-ios-sdk/releases/download/0.5.13/SafeConnection.xcframework.zip'
