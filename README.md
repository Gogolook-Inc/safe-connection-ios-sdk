...
dependencies: [
    .package(url: "https://github.com/Gogolook-Inc/safe-connection-ios-sdk", .upToNextMajor(from: "0.5.8"))
]
// ...
...
### CocoaPods
``` ruby
pod "SafeConnection", :git => "https://github.com/Gogolook-Inc/safe-connection-ios-sdk", :tag => "0.5.8"
```
